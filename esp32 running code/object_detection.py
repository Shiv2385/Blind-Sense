...
import numpy as np
import time
import urllib.request  # Import for fetching ESP32 Camera frames
...
# ESP32 Camera Stream URL (Adjust this based on your ESP32 IP)
...
def run_object_detection():
    ...
    while True:  # Replaces cap.isOpened() since we're using an IP stream
        try:
            ...
            print(f"Error fetching image from ESP32 Camera: {e}")
            time.sleep(1)  # Wait before retrying to avoid excessive errors
